...
urlpatterns = [
    ...
    path("entries/<str:entry_id>/edit/", views.entry_admin_edit, name="entry_admin_edit"),
    path("entries/<str:entry_id>/delete/", views.entry_admin_delete, name="entry_admin_delete"),
    ...
    path("users/<str:user_id>/reset-password/", views.user_reset_password, name="user_reset_password"),
