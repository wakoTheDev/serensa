...
urlpatterns = [
    ...
    path("entries/<int:entry_id>/edit/", views.entry_admin_edit, name="entry_admin_edit"),
    path("entries/<int:entry_id>/delete/", views.entry_admin_delete, name="entry_admin_delete"),
